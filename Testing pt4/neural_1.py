...
def fuzz_layer(layer_class, *inputs):
    try:
        ...
        # Ignore expected exceptions related to initialization
...
def fuzz_test(num_tests=100):
    for _ in range(num_tests):
        ...
        for layer in nn_layers:
            # Specific parameters for layers
            if layer == torch.nn.Linear:
                fuzz_layer(layer, input_shape[1], input_shape[1])
...
# Script didn't silence unwanted errors