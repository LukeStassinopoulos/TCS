...
def create_random_conv_layer():
    ...
    padding = random.randint(0, 10)  # Random padding value for padding
...
# mutations of parameters and values, properly functioning with padding + formatting 