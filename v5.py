...
# Exception occurred during fuzzing: Calculated padded input size per channel: (9 x 16). Kernel size: (11 x 11). Kernel size can't be greater than actual input size